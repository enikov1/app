! function (t, a, e, i) {
	...
	t.fn.initAudioPlayer = function () {
		...
		return this.each(function () {
			...
			//for (let count = 0; count < audioId.length; count++) {
				//audio.src = audioId.attr("data-src");
				//audio.play();
				var i = t(this),
					c = i.attr("src"),
					f = !1;
				if (u(c) ? f = !0 : i.find("source").each(function () {
					...
					var h = t('<div class="mp3Player">' + t("<div>").append(i.eq(0).clone()).html() + '<div class="play-pause-btn"><a href="javascript: void(0);" class="icon icon-mp3player"></a></div></div>'),
						b = h.find("audio")[0];
					h.find("audio").addClass("audio-hidden"), h.append('<div class="player-bar"><div class="player-bar-loaded"></div><div class="player-bar-played"></div></div>');
